...
<div class="page-wrapper" style="margin-bottom: 383px;">
                ...
                <form action="" method="post">
                  ...
                  ?>
                      ...
                      <div id="action_areap" style="display:<?= $display; ?>">
                        ...
                        <input type="submit" class="user_btn_button btn-remove btn btn-primary" name="topup_btn" onclick="return confirm('Are you sure? you wants to Submit.')" value="Topup">
