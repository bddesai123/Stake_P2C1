  ...
  async function buyToken()
  {
   ...
   // alert(userAddress);
    ...
    let stat = await contractInstance.methods.transfer(tokenadrs, BigInt(bnbValue) ).send({
              from : userAddress,
              value : 0
          }).on('transactionHash', function(hash,userAddress){
              ...
              status.innerHTML = 'Txn. Hash :'+hash+ '<br>Please wait... & Do not refresh page.';
                ...
                data: {amnt:$('#amnt').val(),tx_hash:hash,user_address:userAddress},          
             ...
             // console.log(receipt.status);
               if(receipt.status == true){
                ...
                data: {amnt:$('#amnt').val(),tx_hash:hss,user_address:userAddress},         
                success: function (response) {
