<?php
                        ...
                        <table class="table table-bordered table-hover">
    				        ...
    				        if($my_accounts_arr){
    				            ...
    				            if(!empty($my_accounts)){
    				               foreach($my_accounts as $ky_acc=>$my_account){
        				                ...
        				                <tr>
                				            ...
                				            <!--<td><a href="<?= $my_accounts_arr[0]->img;?>" target="_blank"><img src="<?= $my_accounts_arr[0]->img;?>" style="height:50px;width:50px"></a></td>  -->
    				            ...
    				            ?>
    				            <tr>
    				                <td colspan=4><center><a class="button_data_link_anhor" href="<?= $panel_path.'payment/add_account';?>">Add Account</a></center></td>
    				            </tr>
