...
<div class="row pt-2 pb-2">
        <div class="col-sm-12">
            ...
            <li class="breadcrumb-item active" aria-current="page">Binary Matrix</li>
         </ol>
	   </div>
...
$userid = $this->session->userdata('user_id');
           ...
           <center>
            ...
            <div class="form-inline1 col-xl-7">  
               <!--navbar-light bg-light-->
                ...
                <form action="<?= $panel_path.'team/team-binary-pool';?>" class="form-inline my-2 my-lg-0" method="post">
                    ...
                    <a href="<?= $panel_path.'team/team-binary-pool';?>" class="btn btn-secondary my-2 my-sm-0">Reset</a>
                    </ul>
                    </div>
                </form>
    ...
    <?php
            if($node_id){
                $u_id=$this->team->pool_node_binary($node_id);
    ...
    ?>
           <div class="flex">
            ...
            <?php
                ...
                $this->team->binary_matrix_tree(1,$node_id);
            ?>
