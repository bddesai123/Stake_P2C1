    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <form action="<?= $panel_path.'pin/pin-history'?>" method="get">
              <div class="form-inline ml-4 mr-4">
                   ...
                   <select name="pin_type"  id="" class="select_user_panel">
                   ...
                   <select name="tx_type"  id="" class="select_user_panel">
                    ...
                    <input type="text" class="input_user_panel"  Placeholder="From"  name="start_date" value="<?= (isset($_REQUEST['start_date']) ? $_REQUEST['start_date']:''); ?>"/>
                    
                    <span class="input_user_panel">to</span>
                    
                    <input type="text" class="input_user_panel"  Placeholder="End date"  name="end_date" value="<?= (isset($_REQUEST['end_date']) ? $_REQUEST['end_date']:''); ?>" />
