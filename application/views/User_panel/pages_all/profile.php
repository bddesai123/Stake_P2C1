...
$user_id=$profile->id;
  ...
  /* $check_repurchase=$this->conn->runQuery('*','orders',"u_code='$user_id' order by id DESC");
   $join_dats=$check_repurchase[0]->added_on;
   $effectiveDate = date('Y-m-d H:i:s', strtotime("+30 day", strtotime($join_dats)));
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-header-menu">                    
                                    <a href="<?= $panel_path.'profile/edit-profile';?>" class="btn btn-dark"><i class="fa fa-edit"></i></a>
                                </div>
