    ...
    <div class="card card-body card-bg-1">
        ...
        <div class="form-group">
            ...
            <select name="from_wallet" class="check_balance form-control" data-response="from_area" >
             ...
             <span id="from_area" class="text-dark " ><?= form_error('from_wallet');?></span>
        </div>
        <div class="form-group">
            ...
            <span class="text-dark "><?= form_error('to_wallet');?></span>
        </div>
        ...
        <div class="form-group">
            ...
            <button type="submit" class="btn btne" name="convert_btn" >Convert</button>
        </form>
    </div>
    </div>
</div>
