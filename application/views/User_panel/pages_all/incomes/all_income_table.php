        ...
        <div class="card-bg-1" style="background-color:<?= $this->config->item('user_back_color')?>;">
            <form action="<?= $base_url;?>" method="get">
                 <div class="form-inline1 ml-1 mr-1">
                    ...
                    <input type="date" class=" "  Placeholder="End date"  name="end_date" value="<?= (isset($_REQUEST['end_date']) ? $_REQUEST['end_date']:''); ?>" />
                     ...
                     <input type="submit" name="submit" class="both_buttons " value="Filter" />
                     <input type="submit" name="reset" class="both_buttons " value="Reset" />
                        ...
                        foreach($table_data as $t_data){
                            ...
                            <tr>
                              ...
                              <!--  <td class="text-left"><?= $tx_profile ? $tx_profile->name:'';?> ( <?= $tx_profile ? $tx_profile->username : '';?> )</td>-->
                               ...
                               <!-- <td class="text-right"><?= $t_data['distribute_per'];?></td>                               
                                <td class="text-right"><?= $t_data['user_prsnt'];?></td>      -->                         
