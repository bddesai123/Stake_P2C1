<?php
    ...
    $left_teams=$this->team->team_by_position($user_id,1);
    $active_left_team= array_intersect($total_active, $left_teams);
    $left_team=count($active_left_team);
    
    $right_teams=$this->team->team_by_position($user_id,2);
    $active_right_team= array_intersect($total_active, $right_teams);
    $right_team=count($active_right_team);
				...
				<div class="col-xs-12 col-sm-12">
					<div class="corner" style="background-color:#E5E7E9;">
						<div class="card corner" style="background-color:#8B3BEC;">
							...
							<img  src="<?=base_url('images/users/').$profile->img;?>" alt="">
						</div> 
					      <div class="ml-3">
