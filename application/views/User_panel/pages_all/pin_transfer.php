...
<div class="row pt-2 pb-2">
        <div class="col-sm-12">
		    ...
		    <ol class="breadcrumb" style="background-color:#E5EAE9 !important;">
 ...
 ?>
        Pin Available: <span id="total_pins"> <?= $cnt_pins;?></span>    
            ...
            <div class="form-group row">
              <label for="input-1" class="col-sm-2 col-form-label text-dark">Username*</label>
              <div class="col-sm-10">
            ...
            <div class="form-group row">
                <label for="input-1 " class="col-sm-2 col-form-label text-dark">Select Pin*</label> 
                <div class="col-sm-10">
                 <select class="form-control selected_pins" name="selected_pin" id="selected_pin"  data-response="total_pins" required>   
               
                <option value="" class="text-dark">Select Pin</option>
                <?php
            ...
            <div class="form-group row">
                ...
                <small  class="form-text text-dark"><?= form_error('no_of_pins');?></small>
            </div>
            </div>

            <button type="submit" class="btn btne" name="pin_transfer_btn">Transfer</button>
        </form>
