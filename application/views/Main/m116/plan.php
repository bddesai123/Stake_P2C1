 <!-- Banner Section Starts Here -->
        ...
        <div class="container">
            <div class="inner__banner__content text-center">
                ...
                <ul class="breadcums d-flex flex-wrap justify-content-center">
                    <p>To make a solid investment, you have to know where you are investing.<br> Find a plan which is best for you.</p>
                </ul>
            </div>
        </div>
        <div class="shapes">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="section__header text-center">
                        <h2 class="section__header-title">G-Globe Investment Plan</h2>
                        <p style="font-size: medium;">Our goal is to provide our investors with a reliable source of high income, while minimizing any possible risks and offering a high-quality service.</p>
                    </div>
                </div>
            </div>
    ...
    <!-- <section class="plan-section padding-top padding-bottom">
        <div class="container">
            ...
            <div class="col-lg-6 col-md-10">
                <div class="section__header text-center">
                    <h2 class="section__header-title">Our Investment Plan 02</h2>
