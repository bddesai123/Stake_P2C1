        ...
        <div class="container">
            <div class="banner__wrapper d-flex align-items-center justify-content-between">
                <div class="banner__content">
                    <h1 class="title">Invest for Future in Stable Platform</h1>
                    <p>Invest in an Industry Leader, Professional, and Reliable Company. We provide you with the most necessary features that will make your experience better.</p>
                    <a href="<?= base_url();?>register" class="cmn--btn">Get Started</a>
                </div>
                <div class="banner__thumb d-none d-lg-block">
                    <img src="<?= $panel_url;?>assets/images/banner/thumb.png" alt="banner">
                    <div class="shapes">
                        <img src="<?= $panel_url;?>assets/images/banner/big-coin.png" alt="banner" class="shape shape1">
                        <img src="<?= $panel_url;?>assets/images/banner/light.png" alt="banner" class="shape shape2">
                        <img src="<?= $panel_url;?>assets/images/banner/sm-coin.png" alt="banner" class="shape shape3">
                        <img src="<?= $panel_url;?>assets/images/banner/sm-coin.png" alt="banner" class="shape shape4">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="section__thumb rtl">
                        <img src="<?= $panel_url;?>assets/images/choose-us/thumb.png" alt="choose-us">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="choose__us__content">
                        ...
                        <div class="button__wrapper">
                            <a href="<?= base_url();?>about" class="cmn--btn">Know More</a>
                            <a href="#" class="cmn--btn2">Contact Us</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="section__thumb profit__calculation__thumb rtl me-5">
                        <img src="<?= $panel_url;?>assets/images/calculate-profit/thumb.png" alt="profit-calculation">
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="feature-section padding-bottom overflow-hidden">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="section__header text-center">
                        <h2 class="section__header-title">Best G-Globe Investment</h2>
                        <p>Our goal is to provide our investors with a reliable source of high income, while minimizing any possible risks and offering a high-quality service. </p>
                    </div>
                </div>
            </div>
            <div class="feature__slider">
                <div class="single-slide">
                    <div class="feature__item">
                        <div class="feature__item-icon">
                            <img src="<?= $panel_url;?>assets/images/feature/1.png" alt="feature">
                        </div>
                        <div class="feature__item-content">
                            <h4 class="title">Get More Profit</h4>
                            <p>We are offering a certain level of referral income through our referral program.</p>
                        </div>
                    </div>
                </div>
                <div class="single-slide">
                    <div class="feature__item">
                        <div class="feature__item-icon">
                            <img src="<?= $panel_url;?>assets/images/feature/2.png" alt="feature">
                        </div>
                        <div class="feature__item-content">
                ...
                <div class="single-slide">
                    <div class="feature__item">
                        <div class="feature__item-icon">
                            <img src="<?= $panel_url;?>assets/images/feature/3.png" alt="feature">
                        </div>
                        <div class="feature__item-content">
                ...
                <div class="single-slide">
                    <div class="feature__item">
                        <div class="feature__item-icon">
                            <img src="<?= $panel_url;?>assets/images/feature/4.png" alt="feature">
                        </div>
                        <div class="feature__item-content">
                ...
                <div class="single-slide">
                    <div class="feature__item">
                        ...
                        <div class="feature__item-content">
                            <h4 class="title">Relability</h4>
                            <p>We are trusted by a huge number of people. </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                    ...
                    <div class="counter__wrapper row gy-4 gy-sm-5 pt-4 pt-sm-5">
                        <div class="col-6 col-sm-6 col-md-4 col-lg-6 col-xl-4">
                            <div class="counter__item">
                                <div class="counter__item-header d-flex align-items-center">
                                    <div class="icon">
                                        <img src="<?= $panel_url;?>assets/images/download/icon1.png" alt="counter">
                                    </div>
                        ...
                        <div class="col-6 col-sm-6 col-md-4 col-lg-6 col-xl-4">
                            <div class="counter__item">
                                <div class="counter__item-header d-flex align-items-center">
                                    <div class="icon">
                                        <img src="<?= $panel_url;?>assets/images/download/icon2.png" alt="counter">
                                    </div>
                        ...
                        <div class="col-6 col-sm-6 col-md-4 col-lg-6 col-xl-4">
                            <div class="counter__item">
                                <div class="counter__item-header d-flex align-items-center">
                                    <div class="icon">
                                        <img src="<?= $panel_url;?>assets/images/download/icon3.png" alt="counter">
                                    </div>
                ...
                <div class="col-lg-5 d-none d-lg-block">
                    <div class="section__thumb profit__calculation__thumb ">
                        <img src="<?= $panel_url;?>assets/images/download/thumb.png" alt="download">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-10">
                    <div class="section__header text-center max-p">
                        ...
                        <p style="font-size: 14px;font-weight: 700;" class="text-muted">We answer some of your Frequently Asked Questions regarding our platform. If you have a query that is not answered here, Please contact us.</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td data-label="User Name">
                                            <div class="user d-flex flex-wrap align-items-center">
                                                <div class="thumb">
                                                    <img src="<?= $panel_url;?>assets/images/dashboard/item2.png" alt="dashboard">
                                                </div>
                                    ...
                                    <tr>
                                        <td data-label="User Name">
                                            <div class="user d-flex flex-wrap align-items-center">
                                                <div class="thumb">
                                                    <img src="<?= $panel_url;?>assets/images/dashboard/item3.png" alt="dashboard">
                                                </div>
                                    ...
                                    <tr>
                                        <td data-label="User Name">
                                            <div class="user d-flex flex-wrap align-items-center">
                                                <div class="thumb">
                                                    <img src="<?= $panel_url;?>assets/images/dashboard/item4.png" alt="dashboard">
                                                </div>
                                                <p class="name">Robert Mahfuj</p>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td data-label="User Name">
                                            <div class="user d-flex flex-wrap align-items-center">
                                                <div class="thumb">
                                                    <img src="<?= $panel_url;?>assets/images/dashboard/item5.png" alt="dashboard">
                                                </div>
                    ...
                    <div class="testimonial__img__slider">
                        <div class="single-slide">
                            <div class="testimonial__thumb">
                                <img src="<?= $panel_url;?>assets/images/testimonial/item1.png" alt="testimonial">
                            </div>
                        </div>
                        <div class="single-slide">
                            <div class="testimonial__thumb">
                                <img src="<?= $panel_url;?>assets/images/testimonial/item2.png" alt="testimonial">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center g-4">
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="post__item">
                        <div class="post__item-thumb">
                            <img src="<?= $panel_url;?>assets/images/blog/item1.png" alt="blog">
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="post__item">
                        <div class="post__item-thumb">
                            <img src="<?= $panel_url;?>assets/images/blog/item2.png" alt="blog">
                            <div class="thumb__content">
                                <h3 class="title"><a href="blog-details.html">Aenean Ligul Porttitoe Consequat Ditae</a></h3>
                                <ul class="post-meta d-flex flex-wrap m-0 justify-content-between">
                                    <li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="post__item">
                        <div class="post__item-thumb">
                            <img src="<?= $panel_url;?>assets/images/blog/item3.png" alt="blog">
                            <div class="thumb__content">
                                <h3 class="title"><a href="blog-details.html">Aenean Ligul Porttitoe Consequat Ditae</a></h3>
                                <ul class="post-meta d-flex flex-wrap m-0 justify-content-between">
                                    <li>
