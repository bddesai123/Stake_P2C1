                        ...
                        ?>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								...
								<input type="text" class="form-control " id="name" name="name" placeholder="Name" data-response="name_res" value="<?php echo set_value('name');?>">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
								<input type="text" class="form-control " id="useradd" name="useradd" placeholder="Wallet Address" value="<?php echo set_value('useradd');?>">
                                                <span class=" " id="name_res"><?php echo form_error('useradd');?></span> 
							</div>
							</div>
